...
![Vanguard Cloud Services - Aegis ID architecture cover](/images/vanguard-identity-architecture.png)
...
![Vanguard Cloud Services setup walkthrough poster](/images/setup-walkthrough-poster.png)
